...
function TimelineIcon({ state }: { state: 'done' | 'active' | 'pending' }) {
  ...
  if (state === 'active') return <Loader2 size={14} className="text-[#C8F135] animate-spin" />
  ...
  return (
    <div className="relative w-24 h-24 mx-auto">
      <svg viewBox="0 0 100 100" fill="none" className="w-full h-full">
        <circle cx="50" cy="50" r="45" stroke={approved ? '#22c55e' : '#C8F135'} strokeWidth="3" opacity="0.15" />
        <motion.circle
          cx="50" cy="50" r="45"
          stroke={approved ? '#22c55e' : '#C8F135'} strokeWidth="3.5" strokeLinecap="round"
        ...
        <motion.path
          ...
          stroke={approved ? '#22c55e' : '#C8F135'} strokeWidth="5.5" strokeLinecap="round" strokeLinejoin="round"
          initial={{ pathLength: 0 }}
          animate={{ pathLength: 1 }}
        ...
        >
              ...
              {approved ? (
                ...
                >
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed max-w-xs">
                    ...
                    <span className="font-semibold text-[#C8F135]">ko&apos;rib chiqilmoqda</span>...
                  </p>
                </motion.div>
              )}
            </AnimatePresence>
          ...
          >
            {[
              ...
              >
                <div className="w-8 h-8 rounded-lg bg-[#C8F135]/15 flex items-center justify-center flex-shrink-0">
                  <Icon size={15} className="text-[#C8F135]" />
                </div>
                ...
                {state === 'active' && (
                  <span className="ml-auto flex gap-1">
                    {[0, 1, 2].map(i => (
                      <motion.span
                        key={i}
                        className="w-1 h-1 rounded-full bg-[#C8F135]"
              ...
              {approved ? (
                ...
                >
                  ...
                  <button
                    ...
                    style={{ background: 'linear-gradient(135deg, #C8F135 0%, #b3d92f 100%)', color: '#000' }}
                  >
                    <Truck size={18} />
          ...
          <motion.p variants={item} className="text-xs text-gray-400 text-center">
            <Link href="/" className="hover:text-[#C8F135] transition-colors">
